                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 text-right">
                                ...
                                @else
                                    <span class="badge badge-warning pull-right"> Auto Transmission </span>
                                @endif
                                <a data-fancybox="gallery" href="{{ asset('assets/images/vehicle_images/'.$instructor->user_meta->vehicle_image) }}"><img src="{{ asset('assets/images/vehicle_images/'.$instructor->user_meta->vehicle_image) }}" alt="" class="img-responsive"></a>
                                <br>
