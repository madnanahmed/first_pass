                       ...
                       <div class="row">
                           ...
                           <div class="row c-gutter-0">
                               ...
                               <div class="w-100 text-center">
                                   <button id="next_step" class="btn btn-warning w-50">CONTINUE <span class="fa fa-spin fa-spinner hidden"></span></button>
                               </div>
                           </div>
                       </div>
                   </div>
...
@section('script')
    ...
    <script>
        ...
        function ttl(){
            let l_t = false;
            if( $('.test-container').hasClass('active') && $('.driving_lesson.active').hasClass('active') ){
                let t = parseInt( $('.total').text() );
                let test = parseInt( $('.total_test').text() );
