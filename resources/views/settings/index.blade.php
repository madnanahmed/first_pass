...
@section('content')
    ...
    <div class="container-fluid">
        <ul class="nav nav-tabs" role="tablist">
            ...
            <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#twilio" role="tab">
                <span class="hidden-sm-up"><i class="fa fa-stripe"></i></span>
        ...
        <!-- Tab panes -->
            <div class="tab-content tabcontent-border">
                @if(auth()->user()->type == 'admin')
                <div class="tab-pane pt-20" id="twilio" role="tabpanel">
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <form action="" id="stripe_settings_form">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="password"  name="public_key" value="{{ @$stripe_settings->public_key }}" class="form-control" placeholder="">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="password"  name="secret_key" value="{{ @$stripe_settings->secret_key }}" class="form-control" placeholder="">
                                        <span title="show/hide" class="input-group-addon btn btn-success show_password b-0"><i class="fa fa-eye text-white"></i></span>
                                    </div>
                                </div>
                                @if(Auth::user()->type == 'admin')
