...
@section('content')
    ...
    <div class="container-fluid">
        <ul class="nav nav-tabs" role="tablist">
            ...
            <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#appt_email" role="tab"><span class="hidden-sm-up"><i class="ti-email"></i></span> <span class="hidden-xs-down text-uppercase">Appointment EMAIL</span></a> </li>
        </ul>
        <!-- Tab panes -->
                ...
                <div class="tab-pane active p-20" id="home" role="tabpanel">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label for="cono1" class="col-sm-3 text-right control-label col-form-label"> Appointment Email Subject</label>
                                <div class="col-sm-9">
                ...
                <div class="tab-pane p-20" id="appt_email" role="tabpanel">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Appointment Email:</h4>
                                    ...
                                    <div class="form-group d-block mt-2">
                                        ...
                                        <div class="btn-groups w-100">
                                            ...
                                            <button type="button" class="btn btn-primary" onclick="tinymce.get('appt_body').insertContent($(this).val());" value="%APPOINTMENT_DATE%">Appointment date</button>
