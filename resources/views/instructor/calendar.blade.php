        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-success save-event waves-effect waves-light">Create Lesson</button>
                    ...
                    if(id!='') {
                        ...
                        $.post('{{ url('show-event') }}',
                            ...
                            let end_date = data.end_date.split(" ");
                                ...
                                form.find(".row")
                                    .append("<input type='hidden' name='id' value='"+data.id+"'><div class='col-md-12'><div class='form-group'><label class='control-label'>Lesson Detail/Title</label><input required class='form-control' value='"+data.detail+"' placeholder='Lesson Detail/Title' type='text' name='detail' /></div></div>")
                                    .append("<div class='col-md-12'><div class='form-group'><label class='control-label'>Address</label><input class='form-control' value='"+data.address+"' placeholder='Address' type='text' name='address'/></div></div>")
                                    .append("<div class='col-md-3'><div class='form-group'><label class='control-label'>Start date</label><input id='from' class='form-control disable' value='"+st_date[0]+"' disabled name='start_date'></div> </div> " +
                                        ...
                                        '<input type="time" class="form-control start_time" name="start_time" required value="'+st_date[1]+'" />'+
                                        '</div></div>')
