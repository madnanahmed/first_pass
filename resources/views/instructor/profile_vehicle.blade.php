                                                ...
                                                <div class="">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        if($user->user_meta->language!=""){
                                                            $lang = json_decode($user->user_meta->language);
                                                        }
                                                        ?>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="form-group m-t-10">
                                                                ...
                                                                <input type="file" class="form-control" name="vehicle_img" onchange="readURL(this, '.image_preview')">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <img src="{{ $user->user_meta->vehicle_image !=""? asset('assets/images/vehicle_images/'.$user->user_meta->vehicle_image) : '' }} " alt="" class="image_preview img-responsive">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#vehicle_make').change(function (){
                ...
                if(make_id == ''){
                    $('#vehicle_model').html("<option value=''></option>");
                    return ;
                }
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        if(res.success == true){
                            ...
                            $('#vehicle_model').html(res.options);
